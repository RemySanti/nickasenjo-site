...
export function CommercialPhotoLanding() {
  const cities = [
    { 
      name: 'Allentown', 
      slug: 'allentown',
      description: 'Urban architecture, corporate environments, downtown commerce',
      population: '125,000+',
    ...
    { 
      name: 'Bethlehem', 
      slug: 'bethlehem',
      description: 'Industrial heritage, modern venues, collegiate atmosphere',
      population: '77,000+',
    ...
    { 
      name: 'Easton', 
      slug: 'easton',
      description: 'Historic architecture, waterfront, academic excellence',
      population: '28,000+',
    ...
    { 
      name: 'Emmaus', 
      slug: 'emmaus',
      description: 'Small-town elegance, boutique storefronts, community pride',
      population: '11,000+',
    ...
    { 
      name: 'Whitehall', 
      slug: 'whitehall',
      description: 'Modern commercial spaces, retail excellence',
      population: '27,000+',
    ...
    <div className="bg-[#EEEEE8] min-h-screen">
      ...
      <section className="relative h-[60vh] bg-black flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-6">
          <Camera className="w-20 h-20 text-[#BC271C] mx-auto mb-6" />
          <h1 
          ...
          >
            Premium imagery that defines brand excellence across the Lehigh Valley
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-black/70" style={{ fontSize: '1.125rem', lineHeight: '1.8' }}>
              From architectural masterpieces to executive portraits, we create striking photography 
              that positions your brand among industry leaders.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white p-8 border border-black/10">
              ...
              <p className="text-black/70">
                Executive portraits, team photography, and corporate event coverage
              </p>
            </div>
            <div className="bg-white p-8 border border-black/10">
              <h3 
              ...
              <p className="text-black/70">
                High-end product imagery for catalogs, e-commerce, and advertising
              </p>
            </div>
            <div className="bg-white p-8 border border-black/10">
              <h3 
              ...
              <p className="text-black/70">
                Stunning architectural and real estate photography that showcases spaces
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-black py-20 px-6 lg:px-12">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            >
              Lehigh Valley Commercial Photography
            </h2>
            <p className="text-white/70 max-w-3xl mx-auto" style={{ fontSize: '1.125rem' }}>
              Location-specific photography services capturing the essence of each city's business landscape
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cities.map((city) => (
              <a
                key={city.slug}
                href={`#service-commercial-photo-${city.slug}`}
