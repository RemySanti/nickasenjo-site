        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <a href={mailtoOwner()} className="inline-flex items-center gap-3 px-10 py-5 text-white transition-all tracking-wider uppercase hover:scale-105 active:scale-98" style={{ fontFamily: 'Lemon Milk, sans-serif', fontSize: '1rem', background: 'linear-gradient(to right, rgba(255,255,255,0.1), rgba(255,255,255,0.05))', border: '1px solid rgba(255,255,255,0.2)' }}>
